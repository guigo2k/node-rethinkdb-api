...
sys_keepalive="120"
sys_maxsize="65536"
sys_requirements=('bind-utils' 'numactl' 'jq')
...
Options:
  --version | -v     RethinkDB version (required)
  --selinux          SELinux (boolean). Default: false
  --sys-lang         System locale. Default: en_US.UTF-8
  --sys-thp          Transparent Huge Pages. Default: false
  --sys-numa         Non-Uniform Memory Access. Default: false
  --sys-keepalive    IPv4 TCP keepalive. Default: 120
  --sys-maxsize      File max-size. Default: 65536
  --help | -h        Show help
